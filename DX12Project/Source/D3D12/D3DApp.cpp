...
{
	auto currObjectCB = CurFrameResource->ObjectConstBuffer.get();
	for (auto& e : AllRitems)
	{
		...
		if (e->NumFramesDirty > 0)
		{
			...
			CommandListResource::ObjectConstants objConstants;
...
{
	auto currMaterialCB = CurFrameResource->MaterialConstBuffer.get();
